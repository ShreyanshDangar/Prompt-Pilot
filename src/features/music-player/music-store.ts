...
import { deleteAudioFile, deleteLocalTrack, deletePlaylist as deletePlaylistFromDb,
  getAllLocalTracks, getAllPlaylists, getAudioFile, getSetting, putAudioFile, putLocalTracks,
  putPlaylist, putSetting, type StoredLocalTrack, type StoredPlaylist } from "./audio-db"

const LEGACY_MUSIC_STATE_KEY = "prompt-pilot-music"
...
const SETTING_SHUFFLE = "shuffle"
const SETTING_REPEAT = "repeat"
const SETTING_TRACK_ORDER = "trackOrder"
...
type MusicView = "collapsed" | "iconified" | "closed"
...
export type { PersistedLocalTrack }
